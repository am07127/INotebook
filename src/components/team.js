    ...
    {TeamData.map((person) => {
      return (
        <div class="p-4 lg:w-1/2" key = {person.id}>
          <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
            <img alt="team" class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src={person.image} />
      ...
      <div class="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center justify-center w-full mb-8 mt-12">
          ...
          <h2 className="lg:w-2/3 mx-auto leading-relaxed text-xl text-gray-900 font-semibold">Advisory Panel</h2>
        </div>
      ...
      return (
        <div class="p-4 lg:w-1/2" key = {person1.id}>
          <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
            <img alt="team" class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src={person1.image} />
            <div class="flex-grow sm:pl-8">
